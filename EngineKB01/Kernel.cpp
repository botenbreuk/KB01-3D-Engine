...
{
	MeshManager* msm = new MeshManager(Logger, (DirectXRenderer*) Renderer);
	...
	msm->LoadMesh("tiger", "C:\\Program Files (x86)\\Microsoft DirectX SDK (June 2010)\\Samples\\C++\\Direct3D\\Tutorials\\Tut06_Meshes\\tiger.x");
	msm->LoadMesh("tiger", "C:\\Program Files (x86)\\Microsoft DirectX SDK (June 2010)\\Samples\\C++\\Direct3D\\Tutorials\\Tut06_Meshes\\tiger.x");
	msm->LoadMesh("lion", "C:\\Program Files (x86)\\Microsoft DirectX SDK (June 2010)\\Samples\\C++\\Direct3D\\Tutorials\\Tut06_Meshes\\tiger.x");
